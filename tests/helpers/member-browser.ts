...
export const memberFixture:MemberList={actorId:'admin-a',nextCursor:null,operations:[],members:[
...
export async function memberBrowserBundle(){
 ...
 await writeFile(resolve(directory,'entry.js'),`import React from 'react';import {createRoot} from 'react-dom/client';import {MembersPanel} from './panel.js';createRoot(document.getElementById('panel')).render(React.createElement(MembersPanel,{initial:${JSON.stringify(memberFixture)}}));`);
