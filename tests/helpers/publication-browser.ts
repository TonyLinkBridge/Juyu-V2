...
export async function publicationBrowserBundle(){
 ...
 const files=['components/review/useReviewLeaveGuard.ts','review/leave.ts','components/feedback/feedback.ts','editor/inline.ts','editor/table.ts','editor/highlight.ts','editor/print.ts','categories/model.ts','categories/editor.ts','components/categories/ArticleCategories.tsx','fields/model.ts','fields/editor.ts','components/fields/FieldValues.tsx','qa/metadata.ts','history/paths.ts','components/review/PublicationPanel.tsx','review/publication-client.ts','editor/recovery.ts','editor/legacy.ts','editor/document.ts','workspace/model.ts','domain/presentation.ts','media/model.ts','reader/body.ts','reader/inline.ts','science/model.ts','components/gitbook/Media/MediaBlocks.tsx',...['StructuredInline','StructuredDocument','DocumentView','Inline','Heading','Paragraph'].map(f=>`components/gitbook/Reading/${f}.tsx`),...['Math','Diagram','Hint','CodeBlock','CopyCodeButton','DynamicTabs'].map(f=>`components/gitbook/RichBlocks/${f}.tsx`)];
