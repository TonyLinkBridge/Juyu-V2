...
const files=['reader/icon-keys.ts','reader/icons.tsx','components/qa/QaView.tsx','components/qa/AuthenticatedQaAnswer.tsx','components/shell/NavigationLink.tsx','workspace/model.ts',...['TaskCard','TaskColumn','TasksBoard','TasksFilters','TasksList','TasksWorkspace'].map(n=>`components/tasks/${n}.tsx`),'components/feedback/feedback.ts','reader/content-path.ts','components/qa/QaAnswer.tsx','qa/presentation.ts','qa/answer-cache.ts','editor/inline.ts','editor/inline-embed.ts','editor/annotation.ts','editor/table.ts','editor/highlight.ts','editor/print.ts','navigation-settings/model.ts','reader/category-page.ts','components/navigation-settings/ReaderQuickLinks.tsx','components/navigation-settings/CategoryLanding.tsx','fields/model.ts','fields/editor.ts','components/fields/FieldValues.tsx','analytics/search.ts','components/analytics/SearchAnalytics.tsx','analytics/client.ts','components/analytics/ArticleAnalytics.tsx','recent/client.ts','components/recent/RecentRecorder.tsx','favorites/client.ts','components/favorites/FavoriteButton.tsx','history/paths.ts','editor/document.ts','components/gitbook/Reading/InlineAnnotation.tsx','components/gitbook/Reading/StructuredInline.tsx','components/gitbook/Reading/StructuredDocument.tsx','science/model.ts','reader/inline.ts','reader/markdown.ts','components/science-fields.tsx','components/gitbook/Reading/Inline.tsx','components/gitbook/RichBlocks/Math.tsx','components/gitbook/RichBlocks/Diagram.tsx','components/rich-block-fields.tsx','components/editor/TabBodyEditor.tsx','components/editor/colors.ts',...['Hint.tsx','CodeBlock.tsx','CopyCodeButton.tsx','DynamicTabs.tsx','Steps.tsx','Columns.tsx'].map(f=>`components/gitbook/RichBlocks/${f}`),'media/model.ts','media/external-embed.ts','media/code-lines.ts','media/tab-body.ts','media/editor.ts','components/editor/TableConfigFields.tsx','components/editor/ArticleReferenceFields.tsx','components/editor/MediaFields.tsx','components/media-editor.tsx','components/gitbook/Media/ArticleReferenceContext.tsx','components/gitbook/Media/ArticleReference.tsx','components/gitbook/RichBlocks/ActionButton.tsx','components/gitbook/Media/ImageGallery.tsx','components/gitbook/Media/TableExplorer.tsx','components/gitbook/Media/ExternalEmbed.tsx','components/gitbook/Media/MediaBlocks.tsx','pdf/model.ts','pdf/render.ts','components/gitbook/PDF/PDFPage.tsx','components/gitbook/PDF/PrintButton.tsx','components/gitbook/PDF/PDFPrintControls.tsx','feedback/model.ts','components/feedback-dashboard.tsx','domain/presentation.ts','reader/theme.ts','config/reader-presentation.ts','components/reader-chrome.tsx','components/gitbook/ThemeToggler/ThemeToggler.tsx','components/gitbook/Footer/Footer.tsx','components/gitbook/Announcement/AnnouncementBanner.tsx','components/reader-navigation.tsx','components/gitbook/Header/HeaderMobileMenu.tsx','reader/navigation.ts','reader/page-navigation.ts','reader/tree.ts','reader/body.ts','reader/search.ts','reader/recent-search.ts',...['SearchInput.tsx','SearchResults.tsx','SearchPageResultItem.tsx','SearchResultItem.tsx','HighlightQuery.tsx'].map(file=>`components/gitbook/Search/${file}`),...['PageFeedbackForm.tsx','ArticleMarkdownActions.tsx','ReaderAppearance.tsx','NewVersionNotice.tsx','PageCover.tsx','PageCoverImage.tsx','PageTags.tsx','PageHeader.tsx','PageFooterNavigation.tsx','ScrollToTopButton.tsx','PageBody.tsx','DocumentView.tsx','Heading.tsx','Paragraph.tsx','PageAside.tsx','ScrollSectionsList.tsx','useScrollActiveId.ts'].map(file=>`components/gitbook/Reading/${file}`),...['TableOfContents.tsx','PageGroupItem.tsx','ScrollContainer.tsx','PagesList.tsx','PageDocumentItem.tsx','ToggleableLinkItem.tsx','styles.ts'].map(file=>`components/gitbook/TableOfContents/${file}`)];
