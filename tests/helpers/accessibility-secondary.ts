...
secondarySurfaces.push(
 ...
 {name:'category-landing',build:navigationBrowserBundle,root:'presentation',selfMain:true,data:{categoryLanding:{data:{id:category.id,title:category.name,ancestors:[],items:pages,total:1,page:1,pages:1}}}},
