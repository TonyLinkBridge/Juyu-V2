...
export function EditorLoader({initial,newReference=false,newQa=false,newOps=false,fieldDefinitions=[],categoryOptions=[]}:{initial:EditorData|null;newReference?:boolean;newQa?:boolean;newOps?:boolean;fieldDefinitions?:FieldDefinition[];categoryOptions?:CategoryDefinition[]}){return <EditorBoundary><ArticleEditor categoryOptions={categoryOptions} initial={initial} newReference={newReference} newQa={newQa} newOps={newOps} fieldDefinitions={fieldDefinitions}/></EditorBoundary>;}
