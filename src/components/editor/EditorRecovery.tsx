...
export function EditorRecovery({documentId,sequence,busy,copy,onLoad}:{documentId:string;sequence:number|null;busy:boolean;copy:string;onLoad:(data:EditorData)=>void}){
