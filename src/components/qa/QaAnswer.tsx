...
export function QaAnswer({id,title,revision,topics=[],canEdit=false,initial,cacheScope='',locale='zh-CN'}:{id:string;title:string;revision?:number;topics?:string[];canEdit?:boolean;initial?:Publication;cacheScope?:string;locale?:'zh-CN'|'en'}){
