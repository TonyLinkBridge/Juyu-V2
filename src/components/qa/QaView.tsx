...
export function QaView({data,state,initialAnswer,viewerId,searchEnabled=true,locale='zh-CN',withinDocsPage=false}:{searchEnabled?:boolean;initialAnswer?:Publication;viewerId?:string;data?:QaPage;state:'ready'|'denied'|'unavailable'|'invalid';locale?:'zh-CN'|'en';withinDocsPage?:boolean}){
