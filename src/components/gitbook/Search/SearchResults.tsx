...
export function SearchResults({search,scope='all',failed=false,retryHref,locale='zh-CN',children}:{search:TitleSearch;scope?:SearchScope;failed?:boolean;retryHref:string;locale?:'zh-CN'|'en';children?:ReactNode}) {
