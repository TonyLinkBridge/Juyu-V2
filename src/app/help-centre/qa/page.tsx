...
export default async function QaCollectionPage({searchParams}:{searchParams:Promise<Record<string,string|string[]|undefined>>}){
 ...
 return <EntryShell navigation={<ReaderMenu currentHref="/help-centre/qa"/>} search={<FeatureSearch/>}><main id="main-content" className="editor-main search-main"><QaView data={data} state={state} viewerId={access.userId} initialAnswer={state==='ready'?initialAnswer:undefined}/><div className="reader-actions"><EmployeeSignOut/></div></main></EntryShell>;
}
