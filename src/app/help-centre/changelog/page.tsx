...
export default async function Changelog({searchParams}:{searchParams:Promise<{page?:string;lang?:string}>}){
 ...
 return <EntryShell account locale={locale} navigation={<ReaderMenu currentHref="/help-centre/changelog"/>} search={<SearchInput query="" locale={locale}/> }><main id="main-content" className="editor-main search-main reader-changelog">
