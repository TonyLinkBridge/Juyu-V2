...
export interface WorkspaceItem {id:string;title:string;kind:ContentKind;status:Status;revision:number;publishedRevision:number|null;updatedAt:string;author:string;editor:string;submitter:string|null;reviewer:string|null}
