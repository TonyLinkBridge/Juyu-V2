...
export interface EditorData extends MediaEditorData {locale?:'zh-CN'|'en';translationOf?:string|null;translation?:{documentId:string;status:string;publishedRevision:number|null}|null;description?:string;releaseNote?:string;publicationNumber?:number|null;canDirectPublish?:boolean;categoryOptions?:CategoryDefinition[];categoryIds?:string[];fieldDefinitions?:FieldDefinition[];customFields?:FieldSnapshot[];qa?:QaMetadata;kind:ContentKind;audience:Audience;publishedRevision:number|null;iconKey?:ReaderIconKey|null}
