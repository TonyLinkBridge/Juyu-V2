...
export interface EditorData extends MediaEditorData {publicationNumber?:number|null;categoryOptions?:CategoryDefinition[];categoryIds?:string[];fieldDefinitions?:FieldDefinition[];customFields?:FieldSnapshot[];qa?:QaMetadata;kind:ContentKind;audience:Audience;publishedRevision:number|null}
